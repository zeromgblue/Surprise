export async function render(container, data, config) {
    ...
    container.innerHTML = `
        <style>
            ...
            .hint-text { position: absolute; top: 20vh; color: #e2e8f0; font-family: 'Prompt', sans-serif; font-size: 1.5rem; letter-spacing: 2px; text-shadow: 0 0 10px #fb7185; animation: pulse 2s infinite; font-weight: 300; z-index: 25; pointer-events: none;}
            ...
            .m-head { font-family: 'Sawarabi Mincho', serif; font-size: 4rem; color: #be123c; margin-bottom: 20px; font-weight: 700; text-shadow: 0 0 15px #fff, 0 2px 5px #000; text-align:center;}
            .m-body { font-family: 'Prompt', sans-serif; font-size: 1.5rem; color: #0f172a; line-height: 1.6; max-width: 600px; text-align: center; font-weight: 600; background: rgba(255,255,255,0.7); padding: 30px; border-radius: 5px; box-shadow: 0 10px 30px rgba(0,0,0,0.3);}
            .m-foot { font-family: 'Sawarabi Mincho', serif; font-size: 1.5rem; color: #9f1239; margin-top: 30px; font-weight: 700;}
